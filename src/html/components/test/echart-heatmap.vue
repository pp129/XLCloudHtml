<template>
    <div class="cms-content-inner background-gray index">
       <div id="main" style="width: 1050px;height: 405px;"></div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            var hours = ['0点','1点','2点','3点','4点','5点','6点','7点','8点','9点','10点','11点','12点','13点','14点','15点','16点','17点','18点','19点','20点','21点','22点','23点',];
            ...
            option = {
                ...
                xAxis: {
                    ...
                    splitArea: {
                        show: true,
                        areaStyle:{
                             color:['rgb(255,255,255,0.3)','rgb(247,247,247,0.3)']
                        }
                    },
